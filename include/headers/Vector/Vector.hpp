...
namespace NumeriCore
{
	...
	{	
		...
		public:
			...
			template<class u> friend std::ostream& operator<<(std::ostream& os, const Vector<T>& vec); 
		...
		template <class U> double scalarProduct(const Vector<U>& v1, const Vector<U>& v2);
